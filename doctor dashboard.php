...
<head>
    ...
    <meta name="keywords" content="DPP">
    <meta name="description" content="Developed By Aryan Bhardwaz">
...
<body>
                        ...
                        <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="signup as doctor.html">SignUp as Doctor</a>
                                                <a class="dropdown-item" href="signup as patient.html">SignUp as Patient</a>
                                ...
                                <li class="nav-item dropdown active ">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                ...
                                                <a class="dropdown-item" href="login as patient.html">LogIn as Patient</a>
		...
		echo "<script>window.location='login as admin.html'</script>";
                }
        ?>
